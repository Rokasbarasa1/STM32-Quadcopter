...
df = pd.read_csv('4Quadcopter.csv', skipinitialspace=True)

# Extract required columns and divide by 131 to get real values
gyro_adc_0 = df['gyroADC[2]'] / 131  # Gyro values in degrees/sec

debug_0 = df['debug[0]'] / 131       # Center frequency in Hz
debug_1 = df['debug[1]'] / 131       # Center frequency in Hz
debug_2 = df['debug[2]'] / 131       # Center frequency in Hz
...
q_value_harmonic_1 = 500  # Quality factor
q_value_harmonic_3 = 500  # Quality factor

q_value_random_harmonic = 500  # Quality factor


notch_filter = NotchFilterQ(0, q_value_harmonic_1, fs)

notch_filter_harmonic_1_motor_0 = NotchFilterQ(0, q_value_harmonic_1, fs)
notch_filter_harmonic_1_motor_1 = NotchFilterQ(0, q_value_harmonic_1, fs)
notch_filter_harmonic_1_motor_2 = NotchFilterQ(0, q_value_harmonic_1, fs)
notch_filter_harmonic_1_motor_3 = NotchFilterQ(0, q_value_harmonic_1, fs)

notch_filter_harmonic_2_motor_0 = NotchFilterQ(0, q_value_harmonic_1, fs)
notch_filter_harmonic_2_motor_1 = NotchFilterQ(0, q_value_harmonic_1, fs)
notch_filter_harmonic_2_motor_2 = NotchFilterQ(0, q_value_harmonic_1, fs)
notch_filter_harmonic_2_motor_3 = NotchFilterQ(0, q_value_harmonic_1, fs)

notch_filter_harmonic_3_motor_0 = NotchFilterQ(0, q_value_harmonic_3, fs)
notch_filter_harmonic_3_motor_1 = NotchFilterQ(0, q_value_harmonic_3, fs)
notch_filter_harmonic_3_motor_2 = NotchFilterQ(0, q_value_harmonic_3, fs)
notch_filter_harmonic_3_motor_3 = NotchFilterQ(0, q_value_harmonic_3, fs)


notch_filter_harmonic_random_harmonic = NotchFilterQ(0, q_value_random_harmonic, fs)
...
for idx in range(len(gyro_adc_0)):
    ...
    # center_frequency = motor_frequency_low_pass_filter.read(debug_3.iloc[idx])
    motor_0_frequency = debug_0.iloc[idx]
    motor_1_frequency = debug_1.iloc[idx]
    motor_2_frequency = debug_2.iloc[idx]
    motor_3_frequency = debug_3.iloc[idx]


    if center_frequency > 50:
        new_gyro_value = gyro_value

        motor_frequency_average = (motor_0_frequency + motor_1_frequency + motor_2_frequency + motor_3_frequency) / 4


        if center_frequency< nyquist_limit:
            notch_filter_harmonic_1_motor_0.set_center_frequency(motor_0_frequency)
            notch_filter_harmonic_1_motor_1.set_center_frequency(motor_1_frequency)
            notch_filter_harmonic_1_motor_2.set_center_frequency(motor_2_frequency)
            notch_filter_harmonic_1_motor_3.set_center_frequency(motor_3_frequency)

            new_gyro_value = notch_filter_harmonic_1_motor_0.read(new_gyro_value)
            new_gyro_value = notch_filter_harmonic_1_motor_1.read(new_gyro_value)
            new_gyro_value = notch_filter_harmonic_1_motor_2.read(new_gyro_value)
            new_gyro_value = notch_filter_harmonic_1_motor_3.read(new_gyro_value)
        
        if center_frequency*2< nyquist_limit:
            notch_filter_harmonic_2_motor_0.set_center_frequency(motor_0_frequency * 2)
            notch_filter_harmonic_2_motor_1.set_center_frequency(motor_1_frequency * 2)
            notch_filter_harmonic_2_motor_2.set_center_frequency(motor_2_frequency * 2)
            notch_filter_harmonic_2_motor_3.set_center_frequency(motor_3_frequency * 2)

            new_gyro_value = notch_filter_harmonic_2_motor_0.read(new_gyro_value)
            new_gyro_value = notch_filter_harmonic_2_motor_1.read(new_gyro_value)
            new_gyro_value = notch_filter_harmonic_2_motor_2.read(new_gyro_value)
            new_gyro_value = notch_filter_harmonic_2_motor_3.read(new_gyro_value)

        # The third harmonic can get too close to nyquist
        if center_frequency*3< nyquist_limit:
            notch_filter_harmonic_3_motor_0.set_center_frequency(motor_0_frequency * 3)
            notch_filter_harmonic_3_motor_1.set_center_frequency(motor_1_frequency * 3)
            notch_filter_harmonic_3_motor_2.set_center_frequency(motor_2_frequency * 3)
            notch_filter_harmonic_3_motor_3.set_center_frequency(motor_3_frequency * 3)

            new_gyro_value = notch_filter_harmonic_3_motor_0.read(new_gyro_value)
            new_gyro_value = notch_filter_harmonic_3_motor_1.read(new_gyro_value)
            new_gyro_value = notch_filter_harmonic_3_motor_2.read(new_gyro_value)
            new_gyro_value = notch_filter_harmonic_3_motor_3.read(new_gyro_value)
